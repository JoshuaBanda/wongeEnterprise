...
const AllProducts = () => {
    ...
    useEffect(() => {
        const fetchShop = async () => {
            try {
                const { data, error } = await supabase.from('shoptable').select();
    ...
    return (
        <>
            <h3 style={{ textAlign: "center", fontSize: "2em", color: "#666", margin: "80px 0 20px", fontWeight: "bold" }}>
                Our Products
            </h3>
                        ...
                        <div className="product-details">
                            ...
                            <div className="product-actions">
                                ...
                                <div onClick={handleWhatsAppClick}>
                                    <FaPaperPlane style={{ color: "black", paddingLeft: "10px", cursor: 'pointer' }} fontSize={24} />
                                </div>
                            </div>
                        </div>
                        <hr />
